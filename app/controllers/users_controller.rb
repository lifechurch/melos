class UsersController < ApplicationController
  ...
  before_filter :force_login, only: [:show, :notes, :highlights, :bookmarks, :badges, :friends, :share, :edit, :update, :picture, :update_picture, :password, :update_password, :devices, :destroy_device, :update_email, :delete_account, :delete_account_form]
