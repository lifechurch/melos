...
function EllipsisMoreIcon(props) {
	const { width, height, fill, classes } = props
	return (
		<div {...props} className={classes}>
			<svg className='ellipsis-icon' viewBox="0 0 40 11" width={width} height={height} version="1.1" xmlns="http://www.w3.org/2000/svg">
