...
function CheckMark(props) {
	...
	return (
		<div className={classes}>
			<svg className={`checkmark-${dir}`} viewBox="3 9 8 6" width={width} height={height} style={style} version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
