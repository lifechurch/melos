class ApplicationController < ActionController::Base
  ...
  helper_method :sidebar_presenter, :presenter, :client_settings, :recent_versions, :set_cookie, :find_user, :current_date, :last_read, :current_version, :alt_version, :bible_path, :a_very_short_time, :a_short_time, :a_long_time, :a_very_long_time, :bdc_user?
