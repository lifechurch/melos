...
if (typeof window !== 'undefined' && typeof window.Explore.__INITIAL_STATE__ !== 'undefined') {
  initialState = window.Explore.__INITIAL_STATE__
}
...
render(
  ...
  document.getElementById('react-app-Explore')
)
