...
module.exports = fp(function Manifest(fastify, opts, next) {
  fastify.get('/manifest.json', function manifest(req, reply) {
    if (reply.newrelic) {
      reply.newrelic.setTransactionName('json-manifest')
    }
