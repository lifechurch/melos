...
if (typeof window !== 'undefined' && typeof window.Notifications.__INITIAL_STATE__ !== 'undefined') {
	initialState = window.Notifications.__INITIAL_STATE__
}
...
render(
  ...
  document.getElementById('react-app-Notifications')
)
