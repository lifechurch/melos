...
(function withAngular(angular) {
    ...
    angular.module('720kb.tooltips', [])
        ...
        .directive('tooltips', ['$window', '$compile', '$interpolate', '$interval', '$sce', 'tooltipsConfig', '$rootScope',
            function manageDirective($window, $compile, $interpolate, $interval, $sce, tooltipsConfig, $rootScope) {
                ...
                return {
                    ...
                    'link': function linkingFunction($scope, element, attr) {
                        ...
                        var cancelListener = $rootScope.$on("ToolTipOpen", function(event, args) {
                            if ($scope.$id != args.tip) {
                                $scope.hideTooltip();
                            }
                        });
                        ...
                        $scope.getOffsetTop = function getOffsetTop(elem) {
                            ...
                            return offtop - 145; /* Hard-coded Offset for Body Margin from Fixed Header */
                        };
                        ...
                        $scope.showTooltip = function showTooltip() {
                            ...
                            $rootScope.$emit("ToolTipOpen", {tip: $scope.$id});
