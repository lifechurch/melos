...
function LanguageMenu( el , opts ) {
  ...
  this.locales = ["zh-CN","zh-TW","es-ES","en-GB","pt-PT","af","ar","bg","ca","cs","cy","de","da","el","en","es","fa","fi","fr","hi","hu","hr","id","it","ja","km","ko","lv","mk","mn","ms","my","nl","no","pl","pt","ro","ru","sk","sq","sv","sw","ta","th","tl","tr","uk", "vi", "hk"];
