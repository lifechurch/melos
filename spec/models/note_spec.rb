...
describe Note do
  ...
  describe "for reference" do
    ...
    it "should return result for a single verse reference" do
      notes = Note.for_reference(Reference.new("gen.2.1.kjv"))
      notes.should be_a ResourceList
      notes.first.should be_a Note
    end
    it "should return results for a chapter reference" do
      notes = Note.for_reference(Reference.new("gen.2.kjv"))
      notes.should be_a ResourceList
      notes.first.should be_a Note
    end
  end
