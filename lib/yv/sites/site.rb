    ...
    class Site
      ...
      def partners #this static content will eventually come from the API, putting it here for now as white-labels could have issue
        ...
        partners = {:en      => [{name: 'American Bible Society', url: 'http://www.americanbible.org/', image: 'partners/ABS.jpg'},
                                  ...
                                  {name: 'Seed Company', url: 'https://theseedcompany.org', image: 'partners/SeedCompany.jpg'},
                                  ...
                                  {name: 'Wycliffe', url: 'http://www.wycliffe.org', image: 'partners/Wycliffe.jpg'},
                    ...
                    :"fa"     => [{name: 'Elam Ministries', url: 'http://shop.kalameh.com/', image: 'partners/elam.png'}],
